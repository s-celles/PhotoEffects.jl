...
Pkg.develop(path = "..")
Pkg.add(["ImageCore", "ImageFiltering", "FileIO", "ImageIO", "ImageMagick",
    "TestImages", "StaticArrays", "Colors", "Interpolations"])
...
function generate_flow_animation()
    ...
    full_trajectory = vcat(
        forward_trajectory, forward_trajectory[(end - 1):-1:2])
