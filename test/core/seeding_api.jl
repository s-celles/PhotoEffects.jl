...
@testitem "SEED-4, COMP-1, COMP-2: Scatter reproduces old draw" begin
    ...
    new_effect = Voronoi(Scatter(
        points = 100, detail = 1.4, background = 5.0, seed = 42))
...
@testitem "SEED-6: apply with Given consumes no RNG" begin
    ...
    img = rand(RGB{N0f8}, 32, 32)
    pts = [PhotoEffects.SVector(10.0, 10.0), PhotoEffects.SVector(20.0, 20.0),
        PhotoEffects.SVector(10.0, 20.0), PhotoEffects.SVector(20.0, 10.0)]
